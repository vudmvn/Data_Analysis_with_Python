...
| **Week 02** | **Numerical Computing with NumPy** | • [Introduction to NumPy (EN)](lectures/part02-numpy/numpy-intro-en.md)<br>• [Introduction to NumPy (VN)](lectures/part02-numpy/numpy-intro-vn.md) | <a href="lectures/part02-numpy/numpy-intro-en.pdf" target="_blank">PDF (EN)</a><br><a href="lectures/part02-numpy/numpy-intro-vn.pdf" target="_blank">PDF (VN)</a> | 💻 <a href="lectures/part02-numpy/numpy-practice-en.ipynb" target="_blank">numpy-practice-en</a><br>💻 <a href="lectures/part02-numpy/numpy_business_economics_exercises-en.ipynb" target="_blank">numpy_business_economics_exercises-en</a> | - | ✅ *Ready* |
| **Week 03** | **Data Manipulation with Pandas** | • [Introduction to Pandas (EN)](lectures/part03-pandas/pandas-intro-en.md)<br>• [Introduction to Pandas (VN)](lectures/part03-pandas/pandas-intro-vn.md) | - | 💻 <a href="lectures/part03-pandas/pandas-practice-en.md" target="_blank">pandas-practice-en</a><br>💻 <a href="lectures/part03-pandas/pandas-practice-vn.md" target="_blank">pandas-practice-vn</a> | - | ✅ *Ready* |
