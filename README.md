...
| **Tuần 03** | **Thư viện thao tác dữ liệu Pandas** | • [Giới thiệu Pandas](lectures/part03-pandas/pandas-intro-vn.md) | - | 💻 <a href="lectures/part03-pandas/pandas-practice-vn.md" target="_blank">pandas-practice-vn</a> | - | ✅ *Đã sẵn sàng* |
