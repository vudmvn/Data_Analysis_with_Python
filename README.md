...
| **Tuần 02** | **Thư viện tính toán NumPy** | • [Giới thiệu về NumPy](lectures/part02-numpy/numpy-intro-vn.md) | <a href="lectures/part02-numpy/numpy-intro-vn.pdf" target="_blank">PDF (numpy-intro-vn)</a> | 💻 <a href="lectures/part02-numpy/numpy-practice-vn.ipynb" target="_blank">numpy-practice-vn</a><br>💻 <a href="lectures/part02-numpy/numpy_business_economics_exercises-vn.ipynb" target="_blank">numpy_business_economics_exercises-vn</a> | - | ✅ *Đã sẵn sàng* |
