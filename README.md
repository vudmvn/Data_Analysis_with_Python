...
| **Tuần 02** | **Thư viện tính toán NumPy** |• [Giới thiệu về NumPy](lectures/part02-numpy/numpy-intro-vn.md) | - | <a href="lectures/part02-numpy/numpy-practice-vn.ipynb" target="_blank">Notebook</a> | - | - | ✅ *Đã sẵn sàng* |
